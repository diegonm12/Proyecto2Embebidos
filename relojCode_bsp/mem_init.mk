...
# Memory: inst_mem
MEM_0 := baseSystem_inst_mem
$(MEM_0)_NAME := inst_mem
...
$(MEM_0)_HIERARCHICAL_PATH := inst_mem
$(MEM_0)_WIDTH := 32
...
.PHONY: inst_mem
inst_mem: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
